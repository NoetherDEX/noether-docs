...
description: "This page defines the exact math the market contract uses: precision conventions, PnL, margin, funding, liquidation, fees, open-interest caps, and the order-execution…"
---
