...
description: "Every trade on Noether settles against an oracle price. This page explains where that price comes from, how it gets on-chain, and the guard rails that decide when the…"
---
...
The chart and ticker prices you see at [https://testnet.noether.exchange/trade](https://testnet.noether.exchange/trade) come from a different, faster path than the one trades settle on:
