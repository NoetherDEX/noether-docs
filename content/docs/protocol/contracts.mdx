---
title: "Contract addresses & events"
description: "This page is the on-chain reference for Noether: every deployed contract address on the live stack, the network configuration to reach them, and the complete list of…"
---
...
The production stack — what https://testnet.noether.exchange and the gateway at `https://noether-api.proudmeadow-533cf0d8.germanywestcentral.azurecontainerapps.io` serve — deployed 2026-07-06:
