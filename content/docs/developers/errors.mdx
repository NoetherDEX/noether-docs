...
description: "Every error you can hit while integrating with Noether, in one place: the HTTP errors the gateway returns, how failed on-chain transactions surface in API responses, and…"
---
...
All examples below are against the live gateway at `https://noether-api.proudmeadow-533cf0d8.germanywestcentral.azurecontainerapps.io` (Stellar testnet).
...
- [API explorer](/developers/reference) — try the endpoints live
