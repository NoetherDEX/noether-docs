---
title: "Oracle & prices"
description: "Two public endpoints return the current oracle price for Noether's markets: GET /v1/oracle/prices (all assets at once) and GET /v1/markets/{asset}/price (one asset)."
---
...
Base URL: `https://noether-api.proudmeadow-533cf0d8.germanywestcentral.azurecontainerapps.io`. No authentication is required. Responses are cached in the gateway for 3 seconds per asset.
