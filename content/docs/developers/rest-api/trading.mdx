---
title: "Trading (orders & tx)"
description: "This page covers the two endpoints that place and execute trades through the gateway: POST /v1/orders/prepare and POST /v1/tx/submit."
---
...
Base URL: `https://noether-api.proudmeadow-533cf0d8.germanywestcentral.azurecontainerapps.io` (Stellar testnet, test funds).
