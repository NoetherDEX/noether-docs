---
title: "Account"
description: "Reference for the account endpoints of the gateway: your key identity, your events, your open positions, your order history, and the public 14-day volume lookup."
---

Reference for the account endpoints of the gateway: your key identity, your events, your open positions, your order history, and the public 14-day volume lookup. Base URL: `https://noether-api.proudmeadow-533cf0d8.germanywestcentral.azurecontainerapps.io`.
...
```bash
curl -s "https://noether-api.proudmeadow-533cf0d8.germanywestcentral.azurecontainerapps.io/v1/account/volume?address=GDA4JVVUE6CTF7FEGOFMKA3YE4E5J7SAAK7RACZLNIMXYF24OLLR3KZO"
```
...
- [API explorer](/developers/reference) — try these calls interactively
