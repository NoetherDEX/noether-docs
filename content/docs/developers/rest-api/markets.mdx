---
title: "Markets & market data"
description: "Public market-data endpoints of the Noether gateway: the market list, per-asset detail, open interest and volume stats, recent trades, OHLC candles, and the trader…"
---
...
- [API explorer](/developers/reference) — try these endpoints in the browser
