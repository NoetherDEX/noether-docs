---
title: "Referrals"
description: "Noether has an on-chain referral program. This page shows you how to create your referral code, share it, and how referees bind to it — plus what the program pays once…"
---
...
Go to **Referrals** in the top navigation on [noether.exchange](https://testnet.noether.exchange), and connect your wallet if you haven't (see [Getting started](/guides/getting-started)).
