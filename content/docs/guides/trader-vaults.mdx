---
title: "Trader Vaults"
description: "Trader Vaults are user-created copy-trading vaults: a leader trades a shared pool of USDC, depositors hold shares of it, and the leader earns 10% of any gains above the…"
---
...
Open **Vaults** in the header (or go to `https://testnet.noether.exchange/vaults`). The page opens with the protocol **Noether Vault** (the LP pool — see [Liquidity Vault](/guides/vault)), followed by the **Leader Vaults** section. Each vault card shows:
